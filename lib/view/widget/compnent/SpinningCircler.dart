...
class SpinningCircler extends StatefulWidget {
  const SpinningCircler({Key? key}) : super(key: key);

  @override
  _SpinningCirclerState createState() => _SpinningCirclerState();
}

class _SpinningCirclerState extends State<SpinningCircler> with TickerProviderStateMixin {
